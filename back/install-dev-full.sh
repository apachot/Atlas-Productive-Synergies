...
echo ">>> Step 5/${NB} : $(date)"
bin/console app:establishment:initialise  01 03 07 15 26 38 42 43 63 69 73 74 --env=prod
echo ">>> Step 6/${NB} : $(date)"
...
echo ">>> Step 9/${NB} : $(date)"
bin/console app:faker:recommendation  01 03 07 15 26 38 42 43 63 69 73 74 --env=prod
